...
urls_v1 = [
    ...
    path('me/company/products/<int:product_id>/edit/', views.get_product_detail, name='edit_detail'),
    path('me/company/products/<int:product_id>/delete/', views.get_product_detail, name='delete_product'),
    ...
    path('me/company/inventorys/<int:inventory_id>/', views.get_inventory_detail, name='detail_inventory'),
    path('me/company/inventorys/<int:inventory_id>/edit/', views.edit_inventory, name='edit_inventory'),
]
